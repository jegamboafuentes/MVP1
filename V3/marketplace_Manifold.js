...
function manifold1Data(dataFromGCP) {
  ...
  try {
    ...
    //var htmlTableList = t.getElementsByClassName("flex items-center justify-between");
    //var htmlTableList = t.getElementsByClassName("w-full flex justify-between items-center");
    var htmlTableList = t.getElementsByClassName("flex w-full flex-col items-stretch justify-between");
